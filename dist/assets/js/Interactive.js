...
const ihTranslations = {
  ...
  ar: {
    ...
    dtip_bathtub: "الحوض الممتلئ يستهلك 140-200 لتر. ملؤه للنصف يقلل هذا فوراً. اجعل الاستحمام في الحوض لمرة أو مرتين أسبوعياً.",
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if(savedTheme === "light" && themeToggle) themeToggle.classList.replace("fa-sun", "fa-moon");
